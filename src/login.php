    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
          ...
          <div class="form-outline mb-4">
            <input type="email" name="userloginemail" class="form-control form-control-lg"
          ...
          <div class="form-outline mb-3">
            <input type="password" name="userloginpassword" class="form-control form-control-lg"
          ...
          <div class="text-center text-lg-start mt-4 pt-2">
            ...
            <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a href="register.php"
                ...
                <p class="small fw-bold mt-2 pt-1 mb-0">Wanna go back to home page? <a href="index.php"
